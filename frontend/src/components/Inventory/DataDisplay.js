        ...
        return (
            <React.Fragment>
               ...
               <div style={listStyle}>
                ...
                Call #: {this.props.callNum}< br/>
                Status: {this.props.status}< br/>
                Condition: {this.props.condition}< br/>
                Provenance: {this.props.provenance}< br/>
                Replacement Cost: {this.props.replacementCost}< br/>
                Inventory Date: {this.props.inventoryDate}< br/>
                Internal Note 3: {this.props.internalNote3}< br/>
                Permanent Library: {this.props.permLib}< br/>
                Permanent Location: {this.props.permLoc}< br/>
                String 583a: {this.props.string583a}< br/>
                Temp Lib: {this.props.tempLib}< br/>
                Temp Loc: {this.props.tempLoc}< br/>
                </div>
            </React.Fragment>
        )
    }
